    ...
    <div className="bg-gradient-to-b from-white to-blue-50 min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={itemVariants} className="text-center lg:text-left">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 tracking-tight">
                ...
                <span className="block text-indigo-600">Financial Journey</span>
              </h1>
              ...
              <div className="mt-8 flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
                ...
                <Link
                  to="/login"
                  className="px-8 py-3 bg-white text-indigo-600 border border-indigo-600 rounded-lg font-medium hover:bg-indigo-50 transition transform hover:scale-105 focus:outline-none"
                >
                  Log In
                </Link>
              </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-3">
            {/* 功能卡片 1 */}
            <motion.div 
              className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-8 shadow-sm hover:shadow-md transition"
              whileHover={{ y: -5 }}
            >
              <div className="bg-white p-3 rounded-lg inline-block shadow-sm mb-4">
                <ChartIcon />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mt-2">Monitor</h3>
            ...
            {/* 功能卡片 2 */}
            <motion.div 
              className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-8 shadow-sm hover:shadow-md transition"
              whileHover={{ y: -5 }}
            >
              <div className="bg-white p-3 rounded-lg inline-block shadow-sm mb-4">
                <GoalIcon />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mt-2">Visualize</h3>
              <p className="mt-2 text-gray-600">
            ...
            {/* 功能卡片 3 */}
            <motion.div 
              className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl p-8 shadow-sm hover:shadow-md transition"
              whileHover={{ y: -5 }}
            >
              <div className="bg-white p-3 rounded-lg inline-block shadow-sm mb-4">
                <AIIcon />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mt-2">Optimize</h3>
              <p className="mt-2 text-gray-600">
              ...
              <div className="p-6">
                <div className="grid grid-cols-3 gap-4">
                  <div className="col-span-3 sm:col-span-2">
                    <div className="bg-gray-100 rounded-lg p-4 h-40 mb-4">
                      <div className="h-3 w-1/3 bg-indigo-200 rounded mb-2"></div>
                      <div className="h-2 w-full bg-indigo-100 rounded mb-2"></div>
                      <div className="h-2 w-full bg-indigo-100 rounded mb-2"></div>
                      <div className="h-20 w-full bg-indigo-50 rounded mt-4"></div>
                    </div>
                    
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-gray-100 rounded-lg p-4 h-32">
                        <div className="h-3 w-1/2 bg-green-200 rounded mb-2"></div>
                        <div className="h-16 w-full bg-green-50 rounded mt-4"></div>
                      </div>
                      <div className="bg-gray-100 rounded-lg p-4 h-32">
                        <div className="h-3 w-1/2 bg-red-200 rounded mb-2"></div>
                        <div className="h-16 w-full bg-red-50 rounded mt-4"></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-span-3 sm:col-span-1">
                    <div className="bg-gray-100 rounded-lg p-4 h-full">
                      <div className="h-3 w-1/2 bg-purple-200 rounded mb-2"></div>
                      <div className="h-2 w-3/4 bg-purple-100 rounded mb-4"></div>
                      
                      <div className="h-12 w-full bg-white rounded-lg shadow-sm mb-3 p-2 flex items-center">
                        <div className="w-2 h-8 bg-green-400 rounded-sm mr-2"></div>
                        <div>
                      ...
                      <div className="h-12 w-full bg-white rounded-lg shadow-sm mb-3 p-2 flex items-center">
                        <div className="w-2 h-8 bg-red-400 rounded-sm mr-2"></div>
                        <div>
                      ...
                      <div className="h-12 w-full bg-white rounded-lg shadow-sm p-2 flex items-center">
                        <div className="w-2 h-8 bg-blue-400 rounded-sm mr-2"></div>
                        <div>
                          <div className="h-2 w-16 bg-gray-300 rounded"></div>
                          <div className="h-2 w-10 bg-gray-200 rounded mt-1"></div>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <div class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
          <div class="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl shadow-xl p-8 md:p-12 text-white text-center">
            ...
            <div class="mt-8">
              <Link
                to="/signup"
                class="px-8 py-4 bg-white text-indigo-600 rounded-lg font-medium shadow-md hover:bg-indigo-50 transition transform hover:scale-105 focus:outline-none inline-block"
              >
